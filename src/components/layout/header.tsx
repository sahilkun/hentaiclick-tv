...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-14 w-full xl:max-w-[95%] 2xl:max-w-[84%] items-center gap-4 px-4">
        {/* Logo */}
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex h-9 items-center gap-1.5 rounded-md border border-primary/50 px-3 text-sm font-medium text-primary transition-colors hover:bg-accent hover:text-foreground"
      >
